...
/**
 * searchOrchestratedAnalyses
 */
class SearchOrchestratedAnalyses extends Request implements HasBody
{
	use HasJsonBody;
	...
	{
		return "/api/projects/{$this->projectId}/workflowSessions/{$this->workflowSessionId}/analyses:search";
	}
