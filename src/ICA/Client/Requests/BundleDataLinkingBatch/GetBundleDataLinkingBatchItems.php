...
/**
 * getBundleDataLinkingBatchItems
 */
class GetBundleDataLinkingBatchItems extends Request
{
	...
	{
		return "/api/bundles/{$this->bundleId}/dataLinkingBatch/{$this->batchId}/items";
	}
