 ...
 */
class GetDataEligibleForLinking extends Request
{
	...
	{
		return "/api/projects/{$this->projectId}/data/eligibleForLinking";
	}
	 ...
	 * @param null|bool $notLinkedToSample When set to true only data that is unlinked to a sample will be returned. This filter implies a filter of type File.
	...
	public function __construct(
		...
		protected ?bool $notLinkedToSample = null,
