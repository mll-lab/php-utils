...
/**
 * getBundleDataUnlinkingBatchItems
 */
class GetBundleDataUnlinkingBatchItems extends Request
{
	...
	{
		return "/api/bundles/{$this->bundleId}/dataUnlinkingBatch/{$this->batchId}/items";
	}
