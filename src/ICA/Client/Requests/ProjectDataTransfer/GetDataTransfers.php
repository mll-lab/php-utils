 ...
 */
class GetDataTransfers extends Request
{
	...
	{
		return "/api/projects/{$this->projectId}/dataTransfers";
	}


	/**
	 * @param string $projectId
	 * @param null|string $connector The ID of the connector to filter on.
	 * @param null|string $direction The direction to filter on.
