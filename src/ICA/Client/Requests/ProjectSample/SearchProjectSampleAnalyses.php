...
/**
 * searchProjectSampleAnalyses
 */
class SearchProjectSampleAnalyses extends Request implements HasBody
{
	use HasJsonBody;
	...
	{
		return "/api/projects/{$this->projectId}/samples/{$this->sampleId}/analyses:search";
	}
