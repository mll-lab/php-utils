...
class GetProjects extends Request
{
	...
	/**
	 * @param null|string $search Search
	 * @param null|array $userTags User tags to filter on
	 * @param null|array $technicalTags Technical tags to filter on
	 * @param null|bool $includeHiddenProjects Include hidden projects.
	 * @param null|string $region The ID of the region to filter on.
	 * @param null|array $workgroups Workgroup IDs to filter on
	...
	public function __construct(
		...
		protected ?array $userTags = null,
		protected ?array $technicalTags = null,
		protected ?bool $includeHiddenProjects = null,
		protected ?string $region = null,
		protected ?array $workgroups = null,
	...
	public function defaultQuery(): array
	{
		return array_filter([
			...
			'includeHiddenProjects' => $this->includeHiddenProjects,
			'region' => $this->region,
