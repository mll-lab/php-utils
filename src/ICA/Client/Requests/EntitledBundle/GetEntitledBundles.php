 ...
 * getEntitledBundles
 */
class GetEntitledBundles extends Request
{
	...
	{
		return "/api/entitledbundles";
	}


	/**
	 * @param null|string $search Search
	 * @param null|string $userTags User tags to filter on
	 * @param null|string $technicalTags Technical tags to filter on
