...
use MLL\Utils\ICA\Client\Requests\DataFormat\GetDataFormats;
use MLL\Utils\ICA\Client\Resource;
use Saloon\Contracts\Response;

class DataFormat extends Resource
{
	/**
	 ...
	 * - code
	 */
	public function getDataFormats(?string $pageOffset, ?string $pageToken, ?string $pageSize, ?string $sort): Response
	{
		return $this->connector->send(new GetDataFormats($pageOffset, $pageToken, $pageSize, $sort));
	}
}
